...
import { AuthRegistration } from "@/lib/slices/authSlice";
...
const UserRegistration = () => {
  ...
  const handleRegister = (formValue) => {
    const { first_name, last_name, email_id, phone_number, password } = formValue;
    setSuccessful(false);

    dispatch(AuthRegistration({ first_name, last_name, email_id, phone_number, password, toast, router }))
      .unwrap()
      .then(() => {
        setSuccessful(true);
      })
                ...
                {!successful && (
                  <div>
                    <div className="form-group">
                      ...
                      />
                      <ErrorMessage name="first_name" component="div" className="text-red-800" />
                    </div>
                    ...
                    <div className="form-group">
                      ...
                      <Field
                        ...
                        className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                      />
                      <ErrorMessage name="last_name" component="div" className="text-red-800" />
                    </div>
