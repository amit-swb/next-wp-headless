...
const SingleCompanyScreen = () => {
  ...
  const singlecompany = company?.company?.user;
  ...
  return (
    <section className="bg-white dark:bg-gray-900 py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6" suppressHydrationWarning={true}>
      ...
      <div className="grid gap-8 lg:grid-cols-1">
        {singlecompany && (
          <div key={singlecompany._id} className="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
...
const Company = () => {
  return (
    <Suspense fallback={<p>Loading....</p>}>
      <SingleCompanyScreen suppressHydrationWarning={true} />
    </Suspense>
  );
};
