...
export default function Header() {
  ...
  const authName =
    authdata?.company?.user?.company_name ||
    authdata?.admin?.data?.user?.first_name;
      ...
      <header className="bg-gray-50 dark:bg-black">
        ...
        <div className="navbar-menu hidden fixed top-0 left-0 z-50 w-full h-full bg-coolGray-900 bg-opacity-50">
          <div className="fixed top-0 left-0 bottom-0 w-4/6 max-w-xs bg-white">
            ...
            <Link className="navbar-close absolute top-5 p-4 right-3" href="#">
              <svg
                width="12"
                height="12"
                viewBox="0 0 12 12"
