...
const DynamicModal = ({ title, isOpen, onClose, initialValues, validationSchema, onSubmit, formFields, showPassword, passwordVisible }) => {
  return (
                ...
                <div className="grid grid-cols-2 gap-2">
                  {formFields.map(({ name, type, label }) => (
                    <div className="form-group relative" key={name}>
                      ...
                      />
                      {name === "password" && <FontAwesomeIcon icon={showPassword ? faEyeSlash : faEye} onClick={passwordVisible} className="absolute cursor-pointer" style={{ width: "20px", top: "41px", right: "10px" }} />}
