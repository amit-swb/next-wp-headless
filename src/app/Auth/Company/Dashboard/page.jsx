    ...
    <PrivateRoute>
      <section className="company_dashboard_sec">
        ...
        <div className="flex justify-center mb-4 p-4">
          <button onClick={() => setActiveTab("hr")} className={`px-4 py-2 text-md font-medium ${activeTab === "hr" ? "bg-primary-600 text-white" : "bg-gray-200 text-gray-700"} rounded-t-lg`}>
            HR List
          </button>
          <button onClick={() => setActiveTab("employee")} className={`px-4 py-2 text-md font-medium ${activeTab === "employee" ? "bg-primary-600 text-white" : "bg-gray-200 text-gray-700"} rounded-t-lg`}>
            Employee List
          </button>
        </div>
        {activeTab === "hr" && (
          <div className="added_hr_list">
