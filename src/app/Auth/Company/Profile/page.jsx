...
export default function SingleDetails() {
  ...
  const validationSchema = Yup.object().shape({
    company_name: Yup.string()
      .test(
        "len",
        "The company name must be between 3 and 40 characters.",
        (val) =>
    ...
    company_website_url: Yup.string()
      .matches(URL, "Website URL is not valid")
      .required("This field is required!"),

    industry_business_location: Yup.string()
      .test(
        "len",
        "The industry business location must be between 3 and 100 characters.",
        (val) =>
    ...
    company_address: Yup.string()
      .test(
        "len",
        "The company address must be between 5 and 100 characters.",
        (val) =>
    ...
    country: Yup.string()
      .test(
        "len",
        "The country name must be between 2 and 56 characters.",
        (val) =>
          val && val.toString().length >= 2 && val.toString().length <= 56
      )
      .required("This field is required!"),
    ...
    city: Yup.string()
      .test(
        "len",
        "The city name must be between 2 and 85 characters.",
        (val) =>
          val && val.toString().length >= 2 && val.toString().length <= 85
      )
      .required("This field is required!"),
    ...
    contact_person: Yup.string()
      .test(
        "len",
        "The contact person name must be between 3 and 50 characters.",
        (val) =>
    ...
    date_format: Yup.date("Must be a valid date format").required(
